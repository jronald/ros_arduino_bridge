#ifndef _ROS_ros_arduino_diff_drive_OdometryLite_h
#define _ROS_ros_arduino_diff_drive_OdometryLite_h
...
namespace ros_arduino_diff_drive
{
  ...
  class OdometryLite : public ros::Msg
  {
    ...
    const char * getType(){ return "ros_arduino_diff_drive/OdometryLite"; };
